...
public class CommandGroups {
    public static Command transfer(){
        return new Sequential(new Parallel(DepositArm.armTransfer()), DepositClaw.closeClaw(),new Wait(.05), IntakeClaw.openClaw());
    }
    ...
    public static Command retract(){
        return new Parallel(IntakeRotate.center(), IntakeWrist.wristTransfer() , IntakeClaw.closeClaw(), DepositClaw.openClaw(), DepositWrist.wristTransfer(), DepositArm.armTransfer(), Lift.goTo(0), Extendo.goTo(0));
    }
