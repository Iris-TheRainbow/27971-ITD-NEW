...
public class DepositClaw implements Subsystem {
    ...
    private static void close(){ clawServo.setPosition(.45); clawStates.setState(States.CLOSED);}
    private static void open(){ clawServo.setPosition(.2); clawStates.setState(States.OPEN);}
